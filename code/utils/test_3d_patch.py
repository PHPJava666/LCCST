...
def var_all_case_LA(model, num_classes, patch_size=(112, 112, 80), stride_xy=18, stride_z=4):
    ...
    with open('/home/lyj/SS-Net-main/data/LA/test.list', 'r') as f:
        image_list = f.readlines()
    image_list = ["/home/lyj/SS-Net-main/data/LA/2018LA_Seg_Training Set/" + item.replace('\n', '') + "/mri_norm2.h5" for item in image_list]
    ...
    for x in range(0, sx):
        ...
        for y in range(0, sy):
            ...
            for z in range(0, sz):
                ...
                with torch.no_grad():
                    # y1, features = model(test_patch)#0813改
                    # y1, features, sdf = model(test_patch)#
